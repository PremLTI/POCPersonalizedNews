 ...
 onLoadSitePageURL : "https://pgonedev.sharepoint.com/_api/Web/Lists/GetByTitle('Site Pages')/Items?$select=ID,FileRef,CanvasContent1,PGImage,Title,PGLocation,NewsDescription,PGNewsImage,ExternalLink&$filter=PGLocation ne null&$orderby=Modified desc&$top=15",
